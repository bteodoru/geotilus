...
class SoilNamingFactory
{
    ...
    private CasagrandeChartService $chartDiagramService;

    private array $classifiers = [];

    public function __construct(
        GranulometryService $granulometryService,
        CasagrandeChartService $chartDiagramService
    ) {
        $this->granulometryService = $granulometryService;
        $this->chartDiagramService = $chartDiagramService;

...
class NP_074_2022_Naming //implements SoilNamingInterface
{
    ...
    {
        $granulometryClassifier = $this->granulometryFactory->create('np_074_2022');
    ...
    public function getStandardInfo(): array
    {
        return  [
            ...
            'version' => '2022',
            'country' => 'RO',
            'description' => 'Normativul pentru întocmirea documentațiilor geotehnice pentru construcții',
        ];
    }
